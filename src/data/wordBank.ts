...
export const WORD_BANK: Word[] = [
  // === 难度 1: 简单常见 (80个) ===
  // 食物
  { id: 'w1', word: "APPLE", cn: "苹果", hint: "红色的水果，一天一个医生远离我", category: "food", difficulty: 1 },
  { id: 'w2', word: "BANANA", cn: "香蕉", hint: "黄色弯弯的水果，猴子最爱", category: "food", difficulty: 1 },
  { id: 'w3', word: "ORANGE", cn: "橙子", hint: "圆圆的橙色水果，富含维C", category: "food", difficulty: 1 },
  { id: 'w4', word: "BREAD", cn: "面包", hint: "早餐常吃的食物，软软的", category: "food", difficulty: 1 },
  { id: 'w5', word: "EGG", cn: "鸡蛋", hint: "母鸡下的，椭圆形", category: "food", difficulty: 1 },
  { id: 'w6', word: "MILK", cn: "牛奶", hint: "白色的饮料，补钙", category: "food", difficulty: 1 },
  { id: 'w7', word: "RICE", cn: "米饭", hint: "中国人的主食", category: "food", difficulty: 1 },
  { id: 'w8', word: "CAKE", cn: "蛋糕", hint: "生日时吃的甜点", category: "food", difficulty: 1 },
  { id: 'w9', word: "CANDY", cn: "糖果", hint: "甜甜的小零食", category: "food", difficulty: 1 },
  { id: 'w10', word: "WATER", cn: "水", hint: "透明的液体，生命之源", category: "food", difficulty: 1 },
  
  // 日用品
  { id: 'w11', word: "CUP", cn: "杯子", hint: "喝水用的容器", category: "daily", difficulty: 1 },
  { id: 'w12', word: "BOTTLE", cn: "瓶子", hint: "装水或饮料的容器", category: "daily", difficulty: 1 },
  { id: 'w13', word: "BAG", cn: "包", hint: "装东西的袋子", category: "daily", difficulty: 1 },
  { id: 'w14', word: "BOX", cn: "盒子", hint: "方方正正装东西的", category: "daily", difficulty: 1 },
  { id: 'w15', word: "KEY", cn: "钥匙", hint: "开门用的金属物品", category: "daily", difficulty: 1 },
  { id: 'w16', word: "CLOCK", cn: "时钟", hint: "告诉我们时间的", category: "daily", difficulty: 1 },
  { id: 'w17', word: "SOAP", cn: "肥皂", hint: "洗手用的", category: "daily", difficulty: 1 },
  { id: 'w18', word: "TOWEL", cn: "毛巾", hint: "擦手擦脸用的布", category: "daily", difficulty: 1 },
  { id: 'w19', word: "BRUSH", cn: "刷子", hint: "刷东西用的工具", category: "daily", difficulty: 1 },
  { id: 'w20', word: "COMB", cn: "梳子", hint: "梳头发用的", category: "daily", difficulty: 1 },
  
  // 学习用品
  { id: 'w21', word: "BOOK", cn: "书", hint: "读书学习用的", category: "study", difficulty: 1 },
  { id: 'w22', word: "PEN", cn: "钢笔", hint: "写字用的工具", category: "study", difficulty: 1 },
  { id: 'w23', word: "PENCIL", cn: "铅笔", hint: "可以擦掉的笔", category: "study", difficulty: 1 },
  { id: 'w24', word: "PAPER", cn: "纸", hint: "写字画画用的", category: "study", difficulty: 1 },
  { id: 'w25', word: "RULER", cn: "尺子", hint: "量长度画直线用的", category: "study", difficulty: 1 },
  { id: 'w26', word: "ERASER", cn: "橡皮", hint: "擦铅笔字用的", category: "study", difficulty: 1 },
  { id: 'w27', word: "DESK", cn: "书桌", hint: "学习写作业的桌子", category: "study", difficulty: 1 },
  { id: 'w28', word: "BAG", cn: "书包", hint: "装书本的包", category: "study", difficulty: 1 },
